...
FORM_ID = "model_locations2"
FORM_TITLE = "PhotoCity Model Locations"
...
def create_submission_xml(row):
    """Create ODK submission XML from a model_registry CSV row"""
    # Generate image URL and location string from raw data
